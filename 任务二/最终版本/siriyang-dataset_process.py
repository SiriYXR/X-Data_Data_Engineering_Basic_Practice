...
if __name__ == '__main__':
    ...
    # 保存数据集
    train.to_csv("./prepared_dataset/train.csv",index=None)
    validate.to_csv("./prepared_dataset/validate.csv",index=None)
    test.to_csv("./prepared_dataset/test.csv",index=None)
